...
CREATE TABLE `transaksi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idtransaksi` varchar(225) DEFAULT NULL,
...
INSERT INTO `transaksi` VALUES (12,NULL,NULL,'',9,27,10,10000,50000,NULL,'pending'),(13,NULL,NULL,NULL,9,28,5,10000,90000,NULL,'pending');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ulasan` (
  `idulasan` int(11) NOT NULL AUTO_INCREMENT,
  `idtransaksi` int(11) NOT NULL,
...
-- Dump completed on 2023-01-27  0:37:31
